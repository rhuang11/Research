...
jk1 = jk[['CMTE_ID', 'NAME', 'EMPLOYER', 'TRANSACTION_DT', 'TRANSACTION_AMT', 'OCCUPATION']]    
...
# jk1 =  outmerge5b[(outmerge5b['YEAR'] == 2016)]
...
outmerge5b.to_csv('C:/Users/d_huang/Documents/PythonProjects/ESGDATA/' + 'CEOview' + '.csv')
